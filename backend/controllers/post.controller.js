...
export const commentOnPost = async (req, res) => {
    try {
        ...
        post.comments.push(comment); // Ensure you have a comments array in your Post schema
        ...
        console.log("Post comments after attempt to add:", post.comments);
        // Save the updated post with the new comment
        await post.save();

        // Return the updated post with the new comment included
